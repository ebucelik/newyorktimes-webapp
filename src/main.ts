...
function createTopStoryElement(topStory: TopStory) {
    ...
    topStory.results.forEach((result, index) => {
        ...
        favoriteImage.src = isTopStoryIncluded(result.uri) ? "resources/favorite-filled.png" : "resources/favorite.png";
...
function addOrRemoveFavoriteTopStory(result: Result, image: HTMLImageElement) {
    ...
    image.src = isTopStoryIncluded(result.uri) ? "resources/favorite-filled.png" : "resources/favorite.png";
